...
Resolved Hostnames
       ...
       Hostname        | IP/Domain Name | Type | Class | Time To Live
-----------------------+----------------+------+-------+-------------
         UCS           |    1.1.1.5     |  A   |  Any  |     179
       trex-04         |    1.1.1.5     |  A   |  IN   |      61
       trex-04         | 2001:db8:1::5  | AAAA |  IN   |      75
10.56.1.1.cisco.il.lab |  cisco.il.lab  | PTR  |  IN   |     122
----
...
----
{
    ...
    "auto_play_params": {                   <2>
        ...
        "program": {                        <9>
            "00:00:00:70:00:02": {
                "hostnames": ["emu-client-1", "trex-client-1"],
                "type": "TXT",
                "class": "Any",
                "ipv6": True
            }
