...
Lastly, to generate hosts realistically, we provide an engine for building URLs.
[source, json]
.Histogram URLs
----
{
...
.9+| histogram_url              | size                .2+|                 | uint16           | Yes       | Size of url in bytes. Provide a large enough buffer to hold the longest url that can be generated.
                                | offset                                   | uint16           | Yes       | Offset to write in the provided buffer.
...
class Prof1():
    ...
    def create_profile(self, is_ipv6, mac, ipv4, ipv6, dg_4, dst_ipv4, dst_ipv6):
        ...
        c = EMUClientObj(mac = mac.V(),
                         ...
                         ipv6 = ipv6.V(),
                         ipv4_dg = dg_4.V(),
                         plugs  = {'ipfix': self.get_init_json(is_ipv6, Ipv4(dst_ipv4), Ipv6(dst_ipv6)), <1>
                                   'arp': {'enable': True},
                                   'ipv6': {}})
        ns.add_clients(c)
