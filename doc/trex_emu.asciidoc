...
* `exporter_params`: An *optional* JSON object used to configure the exporter used by the client. Please refer to the 'IPFix exporters' section below for more information.
...
The `exporter_params` optional object in the JSON may be used to configure the exporters (udp, file, http, or https). Also, all fields of `exporter_params` are optional. If a given field is not specified, its default value will be used.
[source, json]
.exporter_params example
----
    "exporter_params": {
           "name": "fnf_agg.ipfix",
