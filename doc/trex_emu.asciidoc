...
The best way to learn is through examples. I recently wrote a package for `ping` and will take you through the details and the decisions. We will mostly focus on the fundamentals aforementioned
as they are common to all.
