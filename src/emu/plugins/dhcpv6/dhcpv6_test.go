...
func (o *VethIgmpSim) ProcessTxToRx(m *core.Mbuf) *core.Mbuf {
	...
	src := Ipv6SA("FE08::01")
	dst := Ipv6SA("FE08::200:1ff:fe00:1")
...
func GenerateOfferPacket(xid uint32, src net.IP, dst net.IP, dt int) []byte {
	...
	ianao := []byte{0x12, 0x34, 0x56, 0x78, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x05, 0x00, 0x18, 0x20, 0x01, 0x0d, 0xba, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
