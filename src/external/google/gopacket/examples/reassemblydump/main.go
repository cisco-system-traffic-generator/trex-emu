...
import (
	...
	"external/google/gopacket/examples/util"
	"external/google/gopacket/ip4defrag"
	"external/google/gopacket/layers" // pulls in all layers decoders
	"external/google/gopacket/pcap"
	"external/google/gopacket/reassembly"
)
